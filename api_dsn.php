...
$statment = $conn->prepare("SELECT id_post, judul, tanggal,id_prodi, level, file_url, keterangan  FROM tbl_post WHERE level = 'Dosen / Staf' or level = 'Dosen' order by tanggal;");
